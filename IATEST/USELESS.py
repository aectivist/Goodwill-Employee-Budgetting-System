...
def salespage(page):
    ...
    FormulaSideBar = CTkFrame(CalculatorMargin, border_color="#000000", border_width=1)
    FormulaSideBar.grid(row=0,column=0)
   
    CalculatorSide = CTkFrame(CalculatorMargin, border_color="#000000", border_width=1)
