...
def salespage(page):
    RequestPadding = CTkFrame(page, width=216, height=300, fg_color="#dbdbdb", corner_radius=0)
    OutputPadding = CTkFrame(page, width=365, height=300, fg_color="#dbdbdb", corner_radius=0)
    RequestPadding.grid_propagate(0)
    OutputPadding.grid_propagate(0)
    
    RequestPadding.grid(row=0, column=0, pady = 20, padx = 5)
    OutputPadding.grid(row=0, column=1, pady = 20, padx = 0) 

    #Request Content
    SearchRequestContent = CTkFrame(RequestPadding, width=400, height=120, fg_color="#FFFFFF", corner_radius=0)
    EditsRequestContent = CTkFrame(RequestPadding, width=400, height=220, fg_color="#FFFFFF", corner_radius=0)
    SearchRequestContent.grid(row=0, column=0, pady = 2, padx = 3)
    EditsRequestContent.grid(row=1, column=0, pady = 2, padx = 0) 

    #Output Content
    OutputEditContent = CTkFrame(OutputPadding, width=400, height=130, fg_color="#f07575", corner_radius=0)
    OutputTableContent = CTkFrame(OutputPadding, width=400, height=210, fg_color="#FFFFFF", corner_radius=0)
    OutputEditContent.grid(row=0, column=0, pady = 2, padx = 0)
    OutputTableContent.grid(row=1, column=0, pady = 2, padx = 0) 
#def clientpage(page):
#def assetpage(page):
#def calculator(page):
...
def homepage(page):
    ...
    NotesLabel = CTkLabel(master=NoteButtonBox,height=10, width=5, text="NOTES", anchor=CENTER, fg_color='#194680',text_color='white')
